    ...
    return (
      <div className='container d-flex flex-row align-items-start mt-5 justify-content-between'>
        ...
        <div className='d-flex flex-column ml-5 w-75 justify-content-between mt-5'>
          <div className={`d-flex flex-row align-items-center ${classes.member_header}`}>
            <h1 className={classes.members__title}>{userChoose[memberId].name}</h1>
            ...
            <FavoriteButton size={50} id={memberId} status={userChoose[memberId].isFavorite} />
          </div>
